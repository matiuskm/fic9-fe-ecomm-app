...
class WaybillSuccessResponseModel {
    ...
    factory WaybillSuccessResponseModel.fromJson(String str) => WaybillSuccessResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory WaybillSuccessResponseModel.fromMap(Map<String, dynamic> json) => WaybillSuccessResponseModel(
...
class Result {
    ...
    factory Result.fromMap(Map<String, dynamic> json) => Result(
        ...
        manifest: List<Manifest>.from(json["manifest"].map((x) => Manifest.fromMap(x))),
    );
