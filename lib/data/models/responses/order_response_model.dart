...
class OrderResponseModel {
    ...
    factory OrderResponseModel.fromMap(Map<String, dynamic> json) => OrderResponseModel(
        ...
        availableBanks: List<AvailableBank>.from(json["available_banks"].map((x) => AvailableBank.fromMap(x))),
        availableRetailOutlets: List<AvailableRetailOutlet>.from(json["available_retail_outlets"].map((x) => AvailableRetailOutlet.fromMap(x))),
        availableEwallets: List<AvailableEwallet>.from(json["available_ewallets"].map((x) => AvailableEwallet.fromMap(x))),
        availableQrCodes: List<AvailableQrCode>.from(json["available_qr_codes"].map((x) => AvailableQrCode.fromMap(x))),
        availableDirectDebits: List<AvailableDirectDebit>.from(json["available_direct_debits"].map((x) => AvailableDirectDebit.fromMap(x))),
        availablePaylaters: List<AvailablePaylater>.from(json["available_paylaters"].map((x) => AvailablePaylater.fromMap(x))),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "available_banks": List<dynamic>.from(availableBanks.map((x) => x.toMap())),
        "available_retail_outlets": List<dynamic>.from(availableRetailOutlets.map((x) => x.toMap())),
        "available_ewallets": List<dynamic>.from(availableEwallets.map((x) => x.toMap())),
        "available_qr_codes": List<dynamic>.from(availableQrCodes.map((x) => x.toMap())),
        "available_direct_debits": List<dynamic>.from(availableDirectDebits.map((x) => x.toMap())),
        "available_paylaters": List<dynamic>.from(availablePaylaters.map((x) => x.toMap())),
